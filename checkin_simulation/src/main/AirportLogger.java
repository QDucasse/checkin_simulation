...
public class AirportLogger {
     ...
     * LOG MESSAGE EXAMPLE: "Desk nÂº3 accepted to check-in: John Doe".
     * @param desk
     ...
     * LOG MESSAGE EXAMPLE: "Desk nÂº3: Check-in completed in 5s".
     * @param desk
     *      The desk that accepted the check-in.
     * @throws IOException
     *      If the log file is not found.
     ...
     * LOG MESSAGE EXAMPLE: "Desk nÂº3: John Doe is now checked-in with their baggage!"
     * @param passenger
     ...
     * LOG MESSAGE EXAMPLE: "Desk nÂº3: John Doe has an erroneous flight reference."
     * @param passenger
     *      The passenger that checked-in.
     * @throws IOException
     *      If the log file is not found.
     ...
     * LOG MESSAGE EXAMPLE: "Desk nÂº3: John Doe is already checked-in."
     * @param passenger
     *      The passenger that checked-in.
     * @throws IOException
     *      If the log file is not found.
     ...
     * LOG MESSAGE EXAMPLE: "Desk nÂº3: John Doe has a baggage too wide, the passenger has to pay: 30â‚¬."
     * @param passenger
     *      The passenger that checked-in.
     * @param fee
     ...
     * LOG MESSAGE EXAMPLE: "Desk nÂº3: John Doe could not check-in, this flight is full."
     * @param passenger
     *      The passenger that checked-in.
     * @throws IOException
     *      If the log file is not found.
     ...
     * LOG MESSAGE EXAMPLE: "Desk nÂº3: John Doe could not check-in, this flight's hold is full."
